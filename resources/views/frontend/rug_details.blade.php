                        ...
                        <ul>
                            ...
                            <li>
                                <a href="" class="colourway_data" data-id="{{ $c->colourway_id }}">
                                    <img data-original="{{asset('images/colourway/th/'.$c->colourway_th_image)}}" src="img/sqload.png" alt="{{$c->colourway_name}}" class="img-full load">
                                </a>
                            </li>
                            @endforeach
                        </ul>
                                    ...
                                    <ul class="slides">
                                        <li class="relative">
                                            <a id ="image_data" class="img-pop" href="{{asset('images/colourway/lg/'.$data['product']->colourway_lg_image)}}">
                                                <img id="main_image" src="{{asset('images/colourway/lg/'.$data['product']->colourway_lg_image)}}" class="img-full " alt="{{$data['product']->product_name}}" title="{{!empty($data['colourway']->colourway_name)?$data['colourway']->colourway_name. '|'.$data['product']->product_name:$data['product']->product_name}}" />
                                            </a>
                                            <div class="clickToEn">
                                                <a id ="image_data_click" class="img-pop" href="{{asset('images/colourway/lg/'.$data['product']->colourway_lg_image)}}">
