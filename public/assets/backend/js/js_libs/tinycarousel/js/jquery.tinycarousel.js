...
(function($)
{
    ...
    function Plugin($container, options)
    {
        ...
        this.update = function()
        {
            ...
            self.slidesTotal = $slides.length-1;
            slideCurrent     = self.options.start || 0;
            slidesVisible    = 3;//Math.ceil(viewportSize / slideSize);
        ...
        function setEvents()
        {
            if(self.options.buttons)
            {
                $prev.click(function()
                {
                    return self.move(self.slideCurrent - 3);
                });
                $next.click(function()
                {
					return self.move(self.slideCurrent + 3);
        ...
        function setButtons()
        {
            if(self.options.buttons)
            {
				//console.log(self.slideCurrent+" >= "+self.slidesTotal+" - "+slidesVisible)
